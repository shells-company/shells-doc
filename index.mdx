...
Get your documentation site up and running in <Rainbow>minutes</Rainbow>.
...
Design a docs site that looks <Rainbow>great</Rainbow> and empowers your users.
...
Everything you need to create <Rainbow>world-class</Rainbow> documentation.
