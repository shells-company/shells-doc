...
> "One cannot step twice into the same river, for other waters are continually flowing on." — Heraclitus
>
> Neither can one debug the same code twice, for other bugs are continually flowing in.
