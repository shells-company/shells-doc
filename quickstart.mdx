...
> "One cannot step twice into the same river, for other waters are continually flowing in. Also, the documentation will have changed by then." - Heraclitus (sort of) 🥔
