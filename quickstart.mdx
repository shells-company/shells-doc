...
> "One cannot step twice in the same river, for other waters are ever flowing on to you... unless you're debugging JavaScript, then it's the same bug every time." - Heraclitus (paraphrased) 🥔
