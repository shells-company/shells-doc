...
<AccordionGroup>
  <Accordion icon="github" title="Install the GitHub app">
    Install the Mintlify GitHub app from your [dashboard](https://dashboard.mintlify.com/settings/organization/github-app). This automatically deploys your changes whenever you push to your repository.
  </Accordion>
  <Accordion icon="rocket" title="Publish your docs">
    1. Commit and push your changes.
    2. Your docs will be live in moments!
  </Accordion>
</AccordionGroup>
