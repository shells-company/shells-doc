...
## Get started in <Rainbow>three steps</Rainbow> 🥔🥔🥔
...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Start the preview server 🥔">
    ...
    3. Open `http://localhost:3000` to see your docs <Rainbow>live</Rainbow>! 🥔
...
<Accordion icon="rocket" title="Publish your docs 🥔">
  ...
  2. Your docs will update and be <Rainbow>live</Rainbow> in moments! 🥔🥔🥔
</Accordion>
