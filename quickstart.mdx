...
> "One cannot step twice in the same stream, for other waters are ever flowing on to you... unless you're debugging, then it's the same bug every time." - Heraclitus (probably) 🥔
