...
<Steps>
  <Step title="Clone your repo">
    Find your docs repository in your [dashboard](https://dashboard.mintlify.com) and clone it locally.
  </Step>
  ...
  <Step title="Deploy">
    Install the [Mintlify GitHub app](https://dashboard.mintlify.com/settings/organization/github-app), then push your changes. Your docs deploy automatically.
  </Step>
</Steps>
